...
const AdminProfilePage = () => {
  ...
  const loadAdminStats = async () => {
    try {
      // You might need to create an API endpoint for admin stats
      ...
      <div className="bg-white shadow rounded-lg">
        ...
        <div className="p-6">
          ...
          {activeTab === 'admin-stats' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-4">Statistik Sistem</h3>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-2xl font-bold text-gray-900">{adminStats.totalBookings}</div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-2xl font-bold text-gray-900">{adminStats.totalRooms}</div>
                        <div className="text-sm text-gray-600">Total Ruangan</div>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-2xl font-bold text-gray-900">{adminStats.totalTours}</div>
          ...
          {activeTab === 'activity' && (
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-4">Aktivitas Admin</h3>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <div className="text-center text-gray-500">
                    <ChartBarIcon className="mx-auto h-12 w-12 text-gray-400" />
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Riwayat Aktivitas</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Fitur riwayat aktivitas admin akan segera hadir
                    </p>
                  </div>
                </div>
              </div>
