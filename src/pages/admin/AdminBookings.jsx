...
import { bookingsAPI, downloadFile, adminAPI } from "../../services/api";
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        setStatsData(res.data.data.stats.bookings);
      } catch (error) {
  ...
  const handleConfirmStatusChange = async (adminNote) => {
    ...
    try {
      ...
      setBookings((bookings) =>
        bookings.map((b) =>
          b._id === pendingAction.id
            ? { ...b, status: pendingAction.status }
            : b
        )
      );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-5">
        ...
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-[2px_4px_12px_theme(colors.blue.500,0.5)]">
          <div className="text-md font-bold text-gray-900 mb-2">
            TOTAL PERMINTAAN
          </div>
        ...
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-[2px_4px_12px_theme(colors.yellow.500,0.5)]">
          ...
          <div className="text-sm text-gray-500">Perlu ditinjau admin</div>
        </div>
        ...
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-[2px_4px_12px_theme(colors.green.500,0.5)]">
          ...
          <div className="text-sm text-gray-500">Booking yang disetujui</div>
        </div>
        ...
        <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-[2px_4px_12px_theme(colors.blue.500,0.5)]">
          ...
          <div className="text-4xl font-bold text-blue-600 mb-1">
            {statsData?.summary?.completed ||
              bookings.filter((b) => b.status === "completed").length ||
              0}
          </div>
          <div className="text-sm text-gray-500">Kegiatan telah selesai</div>
        </div>
      </div>
      ...
      <div className="bg-white">
        <div className="px-6 py-4">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Daftar permintaan penggunaan ruangan Pustaka Wilayah Aceh
          </p>
        </div>
          ...
          <table className="min-w-full border-separate border-spacing-0">
            <thead>
              <tr className="border-b border-gray-200 bg-white">
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 rounded-tl-xl">
                  Pengguna
                </th>
                ...
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 rounded-tr-xl">
                  Aksi
                </th>
              </tr>
            </thead>
                  ...
                  <td className="px-6 py-4 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        ...
                        disabled={
                          actionLoading || booking.status !== "approved"
                        }
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-700">
              Menampilkan {bookings.length > 0 ? (currentPage - 1) * 10 + 1 : 0}{" "}
              sampai{" "}
              {Math.min(
                currentPage * 10,
                (currentPage - 1) * 10 + bookings.length
              )}{" "}
              dari total {totalBookings} data
            </div>
            <div className="text-sm text-gray-500">10 data per halaman</div>
          </div>
        </div>
      </div>
      ...
      {totalPages > 1 && (
        <div className="text-center mt-4">
          <div className="text-xs text-gray-500 bg-gray-50 px-3 py-2 rounded-lg inline-block">
            ...
            untuk halaman pertama/terakhir
          </div>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {selectedBooking.roomId?.roomName || "N/A"}
                </p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-500">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">
                  {selectedBooking.participantsCount} orang
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center space-x-2">
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          selectedBooking.documentViewUrl ||
                            selectedBooking.documentUrl,
                          "_blank"
                        )
                      }
                    ...
                    <button
                      onClick={async () => {
                        try {
                          const filename = selectedBooking.documentPath
                            .split("/")
                            .pop();
                          await downloadFile(
                            selectedBooking.documentUrl,
